...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                dcc.RangeSlider(id='payload-slider',min=min_payload,max=max_payload,step=1,value=[min_payload,max_payload]),
...
def get_pie_chart(entered_site):
    ...
    filtered_df.rename(columns={"Launch Site":"Counts"},inplace=True)
